...
public class ApplicationModelFactoryTest {
    ...
    public void should_throw_create_error_exception_when_search_fail() throws Exception {
        given(applicationApi.getApplicationByToken(any(String.class))).willThrow(ApplicationNotFoundException.class);
    ...
    public void should_return_application_found() throws Exception {
        ...
        application.setId(3);
        given(applicationApi.getApplicationByToken(any(String.class))).willReturn((Application) application);
